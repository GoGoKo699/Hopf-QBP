"""Deterministic Hopf validation cases and Hermitian-unitary observables."""
from __future__ import annotations

import numpy as np

from .conventions import join_theta
...
def complex_theta_mag(n: int, seed: int = 2000) -> np.ndarray:
    """Generic complex-chart magnitude block in the chart interior."""
...
def singular_theta_mag(n: int) -> np.ndarray:
    """Magnitude coordinates with exactly zero upstream metric factors."""
